...
project = u'sep'
copyright = u'2014-2016, Kyle Barbary and contributors'
...
latex_documents = [
  ('index', 'sep.tex', u'sep Documentation',
...
texinfo_documents = [
  ('index', 'sep', u'sep Documentation',
   u'Kyle Barbary', 'sep', 'One line description of project.',
   'Miscellaneous'),
]
